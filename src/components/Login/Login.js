                ...
                <div className="col-md-4 col-sm-12">
                    <div className="fromStyle">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            {newUser && <input name="confirmPassword" type="password" onBlur={handelChange} ref={register({ required: true })} placeholder="Confirm Password" />}
                            {errors.confirmPassword && <span>This field is required</span>}
                            <br />
                            <input type="submit" value={newUser ? 'Creat Account' : 'Login'} />
                        </form>
                        <p>{newUser ? 'Already have an account' : 'Create new Account'} <button onClick={() => setNewUser(!newUser)}>{newUser ? 'Login' : 'Create account'}</button> </p>
